...
namespace SqlImporter
{
    public class ConfigValidator : IConfigValidator
    {
        ...
        public bool CheckFirstQueryIsValid(Job job)
        {
            ...
            return CheckQueryIsValid(job, load);
        }
